...
const Navbar = () => {
  return (
    <div className='max-w-7xl w-full  flex h-16 md:h-14 justify-between items-center px-3 md:px-4 border-x dark:border-neutral-800 border-neutral-400/40  relative'>
